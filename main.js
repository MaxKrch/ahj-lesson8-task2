...
class State {}
;// CONCATENATED MODULE: ./src/js/workPlace/RenderWP.js
class RenderWP_Render {
  constructor(container) {
    this.container = container;
    this.widget;
    this.listInstance;
...
;// CONCATENATED MODULE: ./src/js/workPlace/WidgetWP.js

class Instances {
  constructor(container, url) {
    this.rend = new RenderWP_Render(container);
    this.url = url;
    this.state = {
      recconnect: {
        try: 0,
...
;// CONCATENATED MODULE: ./src/js/workLog/RenderWL.js

class RenderWL_Render {
  constructor(container) {
    this.container = container;
    this.widget;
    this.listLog;
  ...
  renderNote(note) {
    const time = moment_default()(note.time).locale('ru').format('HH:mm:ss DD.MM.YY');
...
;// CONCATENATED MODULE: ./src/js/workLog/WidgetWL.js

class Log {
  constructor(container, url) {
    this.rend = new RenderWL_Render(container);
    this.url = url;
    this.state = {
      reconnect: {
        idTimer: null,
...
// const url = "192.168.1.110:7070";
const url = 'ahj-lesson8-task2-backend.onrender.com';
new App('#app', url);
